...
var foodPage = {
        ...
        $(document).on('click', '#approveBtn', function () {
            if (!donateBtnClicked) {
                ...
                if (balanceSumValue == 0) {
                    ...
                    var msg = 'הסל ריק גרדע. אנא הזינו מוצרים לתוך הסל';
                    var btnLabel = 'תודה';
    ...
    setSize: function(){
        ...
        $('#foodArrowLeft').css('font-size',(windowHeight * 0.050) + 'px');
        $('#foodArrowRight').css('font-size',(windowHeight * 0.050) + 'px');
        $('#noteHolder').css('height', '260px');
        $('#noteHolder').css('font-size', (windowHeight * 0.032) + 'px');
        $('.donationArea').css('height', '27%');

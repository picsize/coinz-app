...
var kaparotPage = {
    ...
    setSize: function(){
        var windowHeight = $(window).height();
        $('#donationNote, #moneyType, #to, #name, label[for="to"], label[for="name"], #coin_other').css('font-size', (windowHeight * 0.025) + 'px');
        ...
        $('#toLabel').css('font-size', (windowHeight * 0.025) + 'px');
        $('#toLabelInput').css('font-size', (windowHeight * 0.025) + 'px');
        $('#NameLabel').css('font-size', (windowHeight * 0.025) + 'px');
        $('#nameLabelInput').css('font-size', (windowHeight * 0.025) + 'px');
        //CSS for iPhone4 and small screens
        if (windowHeight < 500) {
            $('#rooster').css('width', '45%');
            $('#rooster').css('top', '10%');
            $('#rooster').css('height', '23%');
            $('hr').css('top', '32%');
            $('#nosach').css('top', '42%');
            $('#nosach').css('left', '9%');
            $('#nosach').css('width', '80%');
            $('#kaparotFor').css('top', '36%');
            $('#donationNote, #moneyType, #to, #name, label[for="to"], label[for="name"], #coin_other').css('font-size', '87%');
    ...
    donate:function(donationSum){
        ...
        self.getHebDate(function(heb_date){
            ...
            var msg = "אנא אשר תרומה בסך" + " " + donationSum + " " + '₪';
